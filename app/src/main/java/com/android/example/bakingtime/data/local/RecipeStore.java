...
public class RecipeStore {
    ...
    private RecipeStore(@NonNull final Context context, @NonNull final String fileName) {
    ...
    public static RecipeStore getInstance(@NonNull final Context context,
                                          @NonNull final String fileName) {
        if (instance == null)
            instance = new RecipeStore(context, fileName);
        return instance;
    }
